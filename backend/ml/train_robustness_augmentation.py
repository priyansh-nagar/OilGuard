"""
Stage 2B: Small CNN Baseline with Training-Only Robustness Augmentation for Oil Spill Detection
...
Experiment: Training-only conservative SAR robustness augmentation.
...
OUTPUT_DIR = PROJECT_ROOT / "backend" / "ml" / "outputs" / "robustness_augmentation"
...
FINAL_MODEL_PATH = OUTPUT_DIR / "oil_spill_cnn_robustness_augmentation.pt"
...
def main():
    print()
    print("=" * 80)
    print("STAGE 2B: SMALL CNN WITH TRAINING-ONLY ROBUSTNESS AUGMENTATION")
    print("=" * 80)
    print()
    ...
    # Initialize model (fresh, not from baseline checkpoint)
    ...
    # Loss and optimizer (unchanged from baseline)
